...
Imagem gerada pelo workflow de versões: `ghcr.io/facrf/agendarx:0.2.1`. É preciso
...
5. mantenha `AGENDARX_IMAGE=ghcr.io/facrf/agendarx:0.2.1` e atualize a versão
   conscientemente;
