...
Imagem gerada pelo workflow de versões: `ghcr.io/facrf/agendarx:0.6.5b`. É preciso
...
5. mantenha `AGENDARX_IMAGE=ghcr.io/facrf/agendarx:0.6.5b` e atualize a versão
   conscientemente;
...
2. Defina `AGENDARX_IMAGE=ghcr.io/facrf/agendarx:0.6.5b` nas variáveis da Stack,
...
Use uma tag explícita, como `0.6.5b`, para atualizações reproduzíveis. A tag
