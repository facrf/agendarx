...
Imagem gerada pelo workflow de versões: `ghcr.io/facrf/agendarx:0.3.0`. É preciso
...
5. mantenha `AGENDARX_IMAGE=ghcr.io/facrf/agendarx:0.3.0` e atualize a versão
   conscientemente;
